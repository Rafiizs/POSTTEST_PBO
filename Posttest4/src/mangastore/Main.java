    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (pilihan == 1) {
                ...
                boolean diskon = input.nextLine().equalsIgnoreCase("y");
                ...
                daftarManga.add(new MangaFisik(judul, harga, jumlah, diskon, cover));
            }
                ...
                daftarManga.add(new MangaDigital(judul, harga, jumlah, diskon, format));
            }
                ...
                daftarManga.add(new MangaPremium(judul, harga, jumlah, diskon, bonus));
            }
